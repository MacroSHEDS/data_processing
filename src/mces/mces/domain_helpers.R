...
## "Ortho Phosphate as P, Filtered"         = c('', 'mg/l', ''),# TODO: add to variables
...
## "Total Nitrate/Nitrite N, Unfiltered"    = c('', '', ''), # TODO: add to variables
## "Nitrite N, Unfiltered"                  = c('', '', 'NO2_N'), # TODO: add to variables
