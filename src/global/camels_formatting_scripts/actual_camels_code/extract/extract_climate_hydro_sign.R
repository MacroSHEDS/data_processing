source(paste(dir_r_scripts,'src/camels/read_camels_hydromet.R',sep=''))
source(paste(dir_r_scripts,'src/camels/clim/clim_indices.R',sep=''))
source(paste(dir_r_scripts,'src/camels/hydro/hydro_signatures.R',sep=''))
source(paste(dir_r_scripts,'src/camels/hydro/hydro_accuracy.R',sep=''))
