#. handle_errors
munge_by_site <- function(domain, site_name, prodname_ms, tracker,
...
#. handle_errors
munge_combined <- function(domain, site_name, prodname_ms, tracker,
                           nolink_regex = '(precip_f|precip_c|precipi)',
                           spatial_regex = '(location|boundary)',
                           silent = TRUE){
...
#. handle_errors
munge_combined_split <- function(domain, site_name, prodname_ms, tracker,
                                 nolink_regex = '(precip_f|precip_c|precipi)',
                                 spatial_regex = '(location|boundary)',
                                 silent = TRUE){
