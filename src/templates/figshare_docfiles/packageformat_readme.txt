...
MacroSheds domain at a time. The official MacroSheds dataset is available at PLACEHOLDER0.
...
MacroSheds data heedlessly. See the data policy (data_use_policy.txt, alongside this readme)
