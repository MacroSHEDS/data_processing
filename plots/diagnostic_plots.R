...
# OBSOLETE Q by domain (line plots stitched) ####
...
for(i in 1:length(q_dirs)){
    ...
    if(ntw_dmn_prd[2] %in% c('hjandrews', 'luquillo')){
        ylims = c(0, min(3500, max(d$val, na.rm=TRUE)))
    } else {
...
# OBSOLETE Q vs. flux of Ca, Si, Cl, NO3-N, DOC and SO4 (scatter plot, dark) ####
